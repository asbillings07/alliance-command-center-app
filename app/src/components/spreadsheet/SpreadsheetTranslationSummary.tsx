...
export function SpreadsheetTranslationSummary(props: SpreadsheetTranslationSummaryProps) {
      ...
      <div className="bg-card border border-border rounded-xl p-4 space-y-3 text-xs">
        <div className="flex items-center justify-between border-b border-border pb-2">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h4 className="font-semibold text-foreground text-sm">Planned Metric Translation</h4>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[11px]">
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Matched Members</span>
            <span className="text-lg font-bold text-foreground">{summary.matchedMembersCount}</span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Total Metric Entries</span>
            <span className="text-lg font-bold text-foreground">{summary.totalEntriesCount}</span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Existing / Attached Metrics</span>
            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400">
              {summary.reusedExistingMetricsCount + summary.attachedLibraryMetricsCount}
            </span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">New Metrics to Create</span>
        ...
        {(summary.skippedColumnsCount > 0 ||
          ...
          <div className="text-[11px] text-muted-foreground flex flex-wrap gap-x-4 gap-y-1 bg-muted/20 p-2 rounded border border-border/30">
  ...
  if (props.mode === "committed_metrics") {
    const { summary } = props;
    return (
      <div className="bg-card border border-emerald-500/30 rounded-xl p-4 space-y-3 text-xs">
        <div className="flex items-center justify-between border-b border-border pb-2">
          <div className="flex items-center space-x-2">
            <span className="text-emerald-500 font-bold text-base">✅</span>
            <div>
              <h4 className="font-semibold text-foreground text-sm">Committed Metric Translation</h4>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-[11px]">
          <div className="bg-emerald-500/10 p-2.5 rounded-lg border border-emerald-500/20">
            <span className="text-muted-foreground block">Total Entries Committed</span>
            <span className="text-xl font-bold text-emerald-600 dark:text-emerald-400">
              {summary.totalValuesCommitted}
            </span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Reused / Attached Metrics</span>
            <span className="text-lg font-bold text-foreground">
              {summary.reusedMetrics.length + summary.attachedMetrics.length}
            </span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">New Metrics Created</span>
            <span className="text-lg font-bold text-foreground">
        ...
        {summary.perMetricCounts.length > 0 && (
          <div className="space-y-1.5 pt-1">
            <h5 className="font-medium text-[11px] text-foreground">Entries by Metric:</h5>
            <div className="flex flex-wrap gap-2 text-[11px]">
              {summary.perMetricCounts.map((m) => (
                <span
                  key={m.metricId}
                  className="bg-muted/60 px-2 py-1 rounded border border-border/40 text-foreground font-mono"
                >
      ...
      <div className="bg-card border border-border rounded-xl p-4 space-y-3 text-xs">
        <div className="flex items-center justify-between border-b border-border pb-2">
          <div className="flex items-center space-x-2">
            <span className="text-blue-500 font-bold text-base">🔍</span>
            <div>
              <h4 className="font-semibold text-foreground text-sm">Planned Alliance Member Translation</h4>
              <p className="text-[11px] text-muted-foreground">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[11px]">
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Members to Create</span>
            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400">
              {summary.membersToCreateCount}
            </span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Archived to Restore</span>
            <span className="text-lg font-bold text-blue-600 dark:text-blue-400">
              {summary.archivedMembersToRestoreCount}
            </span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Active Members Unchanged</span>
            <span className="text-lg font-bold text-muted-foreground">
              {summary.existingActiveMembersUnchangedCount}
            </span>
          </div>
          <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
            <span className="text-muted-foreground block">Total Rows Processed</span>
            <span className="text-lg font-bold text-foreground">{summary.totalRowsProcessed}</span>
          </div>
        </div>
    ...
    <div className="bg-card border border-emerald-500/30 rounded-xl p-4 space-y-3 text-xs">
      <div className="flex items-center justify-between border-b border-border pb-2">
        <div className="flex items-center space-x-2">
          <span className="text-emerald-500 font-bold text-base">✅</span>
          <div>
            <h4 className="font-semibold text-foreground text-sm">Committed Alliance Member Translation</h4>
            <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[11px]">
        <div className="bg-emerald-500/10 p-2.5 rounded-lg border border-emerald-500/20">
          <span className="text-muted-foreground block">New Members Created</span>
          <span className="text-xl font-bold text-emerald-600 dark:text-emerald-400">
            {summary.createdCount}
          </span>
        </div>
        <div className="bg-blue-500/10 p-2.5 rounded-lg border border-blue-500/20">
          <span className="text-muted-foreground block">Archived Members Restored</span>
        ...
        <div className="bg-muted/40 p-2.5 rounded-lg border border-border/40">
          <span className="text-muted-foreground block">Skipped / Duplicates</span>
          <span className="text-lg font-bold text-muted-foreground">
