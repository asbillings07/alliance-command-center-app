    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <form className="flex w-full max-w-md flex-col gap-2" action={formAction}>
                ...
                <input className="border border-gray-300 rounded-md p-2" maxLength={7} required type="text" inputMode="numeric" pattern="[0-9]{1,7}" name="allianceServerNumber" aria-label="Alliance Server Number" placeholder="Alliance Server Number" />
